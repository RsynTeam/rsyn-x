...
class ViaRuleData : public PhysicalObject {
       public:
        ...
        Rsyn::PhysicalLayerData* clsLayers[NUM_VIA_LAYERS];  // top or bottom
                                                             // layer levels.
                                                             // Cut is only for
                                                             // generate type
        Rsyn::PhysicalLayerDirection clsLayerDirection
            [NUM_VIA_LEVELS];  // Directions for top or bottom layer levels.
        DBU clsWidth[NUM_VIA_LEVELS][NUM_VIA_RANGES];  // Specifies a wire width
                                                       // range  for bottom and
                                                       // top layer levels.
