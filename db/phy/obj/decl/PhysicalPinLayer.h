...
class PhysicalPinLayer : public Proxy<PhysicalPinLayerData> {
       ...
       protected:
        //! @brief Constructs a Rsyn::PhysicalPinLayer object with a pointer to
        //! Rsyn::PhysicalPinLayerData.
        PhysicalPinLayer(PhysicalPinLayerData* data) : Proxy(data) {}

       public:
        //! @brief Constructs a Rsyn::PhysicalPinLayer object with a null
        //! pointer to Rsyn::PhysicalPinLayerData.
        PhysicalPinLayer() : Proxy(nullptr) {}
        //! @brief Constructs a Rsyn::PhysicalPinLayer object with a null
        //! pointer to Rsyn::PhysicalPinLayerData.
        PhysicalPinLayer(std::nullptr_t) : Proxy(nullptr) {}

        //! @brief Returns the vector reference of rectangular bounds to the
        //! Rsyn::PhysicalPinLayer.
        const std::vector<Bounds>& allBounds() const;
        //! @brief Returns the vector reference of polygons to the
        //! PhysicalPinLayer.
        const std::vector<Polygon>& allPolygons() const;
        //! @brief Returns the Rsyn::PhysicalLayer object related to the
        //! Rsyn::PhysicalPinLayer.
        Rsyn::PhysicalLayer getLayer() const;
        //! @brief Returns the total number of rectangular Bounds that defines
        //! Rsyn::PhysicalPinLayer
        std::size_t getNumBounds() const;
        //! @brief Returns the total number of Polygons that defines
        //! Rsyn::PhysicalPinLayer
        std::size_t getNumPolygons() const;
        //! @brief Returns true if the Rsyn::PhysicalPinLayer has rectangular
        //! Bounds.
        ...
        //! @brief Returns true if the Rsyn::PhysicalPinLayer has no rectangular
        //! Bounds.
        //! Otherwise, returns false.
        ...
        //! @brief Returns true if a Rsyn::PhysicalLayer object is associated to
        //! the Rsyn::PhysicalPinLayer.
        //! Otherwise, returns false.
        bool hasLayer() const;
