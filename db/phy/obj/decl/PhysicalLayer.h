...
class PhysicalLayer : public Proxy<PhysicalLayerData> {
       ...
       protected:
        //! @brief Constructs a Rsyn::PhysicalLayer object with a pointer to
        //! Rsyn::PhysicalLayerData.
        PhysicalLayer(PhysicalLayerData* data) : Proxy(data) {}

       public:
        //! @brief Constructs a Rsyn::PhysicalLayer object with a null pointer
        //! to Rsyn::PhysicalLayerData.
        ...
        //! @brief Returns the layer type (ROUTING, CUT, OVERLAP, MASTERSLICE,
        //! or IMPLANT).
        ...
        //! @brief Returns the layer index w.r.t to all physical layers. It
        //! starts
        //!        from 0 that is the bottom layer
        //! @note  If you need an index relative to the layer type, see
        //!        getRelativeIndex().
        int getIndex() const;
        //! @brief Returns the relative layer index w.r.t. the layers of same
        //! type.
