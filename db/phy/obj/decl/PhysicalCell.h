...
class PhysicalCell : public PhysicalInstance {
       ...
       public:
        ...
        //! @details Cell displacement is the difference between the current
        ...
        //! @brief Returns cell displacement to the given position and given
        //! dimension.
        //! @details Cell displacement is the difference between the current
        //! position of the cell
        ...
        //! position of the cell
        //! and the given position in the given dimension.
        DBU getDisplacementFromCurrentPosition(const DBU pos,
                                               const Dimension dim) const;
        DBU getDisplacementFromInitialPosition(const DBUxy pos) const;
        DBU getDisplacementFromInitialPosition(const DBU pos,
                                               const Dimension dim) const;
        ...
        //! @brief Returns true if the cell boundaries is defined by a
        //! PhysicalLayer. Otherwise, returns false.
        //! @details Cell boundaries may be defined by some PhysicalLayer
        //! instead of rectangular Bounds.
        //! In the 2015 ICCAD contest, some macro have their boundaries defined
        //! by metal1 layer.
