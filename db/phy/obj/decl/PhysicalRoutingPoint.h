...
class PhysicalRoutingPoint : public Proxy<PhysicalRoutingPointData> {
       ...
       protected:
        //! @brief Constructs a Rsyn::PhysicalRoutingPoint object with a pointer
        //! to Rsyn::PhysicalRoutingPointData.

        PhysicalRoutingPoint(PhysicalRoutingPointData* data) : Proxy(data) {}

       public:
        //! @brief Constructs a Rsyn::PhysicalRoutingPoint object with a null
        //! pointer to Rsyn::PhysicalRoutingPointData.
...
class PhysicalRoutingPointPair {
       ...
       public:
        ...
        DBUxy getExtendedSourcePosition() const {
                return clsExtendedSourcePosition;
        }
        DBUxy getExtendedTargetPosition() const {
                return clsExtendedTargetPosition;
        }
