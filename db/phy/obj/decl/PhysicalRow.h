...
class PhysicalRow : public Proxy<PhysicalRowData> {
       ...
       protected:
        //! @brief Constructs a Rsyn::PhysicalRow object with a pointer to
        //! Rsyn::PhysicalRowData.
        PhysicalRow(PhysicalRowData *data) : Proxy(data) {}

       public:
        //! @brief Constructs a Rsyn::PhysicalRow object with a null pointer to
        //! Rsyn::PhysicalRowData.
        ...
        //! @brief Returns the Rsyn::PhysicalRow step length. In X is the width
        //! while in Y is the height.
        DBUxy getStep() const;
        ...
        //! @brief Returns the coordinate point in the left-lower (LOWER
        //! parameter) or right-upper (UPPER parameter) corner.
        ...
        //! @brief Returns the Rsyn::PhysicalOrientation of th
        //! eRsyn::PhysicalRow.
        //! @details Rsyn::PhysicalOrientation may be: 1) ORIENTATION_N, 2)
        //! ORIENTATION_E,
        //! 3) ORIENTATION_S, 4) ORIENTATION_W, 5) ORIENTATION_FN, 6)
        //! ORIENTATION_FE,
        ...
        //! @details Rsyn::PhysicalSymmetry may be: 1) SYMMETRY_X, or 2)
        //! SYMMETRY_Y.
