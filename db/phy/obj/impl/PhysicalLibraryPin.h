...
inline std::vector<PhysicalPinGeometry>&
PhysicalLibraryPin::allPinGeometries() {
        return data->clsPhysicalPinGeometries;
}  // end method

// -----------------------------------------------------------------------------

inline const std::vector<PhysicalPinGeometry>&
PhysicalLibraryPin::allPinGeometries() const {
        return data->clsPhysicalPinGeometries;
}  // end method
