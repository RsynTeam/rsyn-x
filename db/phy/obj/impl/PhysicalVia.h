...
inline Rsyn::PhysicalLayer PhysicalVia::getLayer(
    const PhysicalViaLayerType type) const {
...
inline DBU PhysicalVia::getEnclosure(const ViaLevel level,
...
inline DBU PhysicalVia::getOffset(const ViaLevel level,
                                  const Dimension dim) const {
...
inline const std::vector<Rsyn::PhysicalViaGeometry>&
PhysicalVia::allBottomGeometries() const {
...
inline const std::vector<Rsyn::PhysicalViaGeometry>&
PhysicalVia::allCutGeometries() const {
...
inline const std::vector<Rsyn::PhysicalViaGeometry>&
PhysicalVia::allTopGeometries() const {
        return allGeometries(TOP_VIA_LAYER);
}  // end method

// -----------------------------------------------------------------------------

inline const std::vector<Rsyn::PhysicalViaGeometry>& PhysicalVia::allGeometries(
