...
class WriterDEF : public Rsyn::Service {
       ...
       public:
        WriterDEF() { reset(); }  // end constructor
        ...
        void setPath(const std::string& path) { clsPath = path; }  // end method
        ...
        void setUnits(const bool enable) { clsUnits = enable; }  // end method

        void setHistory(const bool enable) {
                clsHistory = enable;
        }  // end method

        void setExt(const bool enable) { clsExt = enable; }  // end method
        ...
        void setRows(const bool enable) { clsRows = enable; }  // end method

        void setTracks(const bool enable) { clsTracks = enable; }  // end method

        void setGCellGrids(const bool enable) {
                clsGCellGrids = enable;
        }  // end method

        void setVias(const bool enable) { clsVias = enable; }  // end method

        void setStyles(const bool enable) { clsStyles = enable; }  // end method
        ...
        void setPins(const bool enable) { clsPins = enable; }  // end method
        ...
        void setSlots(const bool enable) { clsSlots = enable; }  // end method

        void setFills(const bool enable) { clsFills = enable; }  // end method

        void setSpecialNets(const bool enable) {
                clsSpecialNets = enable;
        }  // end method

        void setNets(const bool enable) { clsNets = enable; }  // end method
        ...
        void setGroups(const bool enable) { clsGroups = enable; }  // end method

        void cleanPath() { clsPath.clear(); }  // end method

        void cleanFilename() { clsFilename.clear(); }  // end method
        ...
        double getDefVersion() { return clsDefVersion; }  // end method

        bool isPathSet() const { return !clsPath.empty(); }  // end method

        bool isFilenameSet() const {
                return !clsFilename.empty();
        }  // end method

        bool isVersion() { return clsVersion; }  // end method

        bool isDeviderChar() { return clsDeviderChar; }  // end method

        bool isBusBitChar() { return clsBusBitChar; }  // end method

        bool isTechnlogy() { return clsTechnlogy; }  // end method

        bool isUnits() { return clsUnits; }  // end method

        bool isHistory() { return clsHistory; }  // end method

        bool isExt() { return clsExt; }  // end method

        bool isPropertyDefinitionsEnabled() const {
                return clsPropertyDefinitions;
        }  // end method

        bool isDieAreaEnabled() const { return clsDieArea; }  // end method

        bool isRowsEnabled() const { return clsRows; }  // end method

        bool isTracksEnabled() const { return clsTracks; }  // end method

        bool isGCellGridsEnabled() const {
                return clsGCellGrids;
        }  // end method

        bool isViasEnabled() const { return clsVias; }  // end method

        bool isStylesEnabled() const { return clsStyles; }  // end method

        bool isNonDefaultRulesEnabled() const {
                return clsNonDefaultRules;
        }  // end method

        bool isRegionsEnabled() const { return clsRegions; }  // end method
        ...
        bool isPinsEnabled() const { return clsPins; }  // end method

        bool isPinPropertiesEnabled() const {
                return clsPinProperties;
        }  // end method

        bool isBlockagesEnabled() const { return clsBlockages; }  // end method

        bool isSlotsEnabled() const { return clsSlots; }  // end method

        bool isFillsEnabled() const { return clsFills; }  // end method

        bool isSpecialNetsEnabled() const {
                return clsSpecialNets;
        }  // end method

        bool isNetsEnabled() const { return clsNets; }  // end method
        ...
        bool isGroupsEnabled() const { return clsGroups; }  // end method
