...
class TupleElement : public std::tuple<_Elements...> {
       public:
        typedef typename std::tuple_element<index,
                                            std::tuple<_Elements...>>::type T;

        TupleElement() {}
        TupleElement(const std::tuple<_Elements...> &t)
            : std::tuple<_Elements...>(t) {}
        void operator=(const std::tuple<_Elements...> &t) {
                std::tuple<_Elements...>::operator=(t);
        }
