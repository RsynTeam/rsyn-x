...
class Arc : public Proxy<ArcData> {
       ...
       public:
        ...
        //! @brief Returns the instance to which this arc is associated if any.
        //! If
        ...
        //! @brief Returns the library arc related to this arc if any. If this
        //! is a
        //!        net arc, returns null.
        LibraryArc getLibraryArc() const;

        //! @brief Returns the library cell related to this arc if any. If this
        //! is a
        //!        net arc or belong to an instance without library cell,
        //!        returns
        //!        null.
        ...
        //! library cell. If this arc does not belong to an instance (i.e. net
        //! arc),
        //! returns -1.
        int getIndex() const;
};  // end class
