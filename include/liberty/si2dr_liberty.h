...
#undef SI2_ARGS
#endif
#if defined(__STDC__) || defined(HPPA) || defined(ibmpoweraix) || \
...
typedef enum si2drAttrTypeT { SI2DR_SIMPLE, SI2DR_COMPLEX } si2drAttrTypeT;
...
typedef struct si2drExprT {
        ...
        struct si2drExprT
            *left; /* the exprs form a classic binary tree rep of an arithmetic
                      expression */
...
si2drStringT si2drAttrGetName SI2_ARGS((si2drAttrIdT attr, si2drErrorT *err));
...
si2drVoidT si2drIterNextComplexValue
SI2_ARGS((si2drValuesIdT iter, si2drValueTypeT *type, si2drInt32T *intgr,
...
si2drValueTypeT si2drComplexValGetValueType
SI2_ARGS((si2drAttrComplexValIdT attr, si2drErrorT *err));

si2drInt32T si2drComplexValGetInt32Value SI2_ARGS((si2drAttrComplexValIdT attr,
                                                   si2drErrorT *err));

si2drFloat64T si2drComplexValGetFloat64Value
SI2_ARGS((si2drAttrComplexValIdT attr, si2drErrorT *err));

si2drStringT si2drComplexValGetStringValue
SI2_ARGS((si2drAttrComplexValIdT attr, si2drErrorT *err));

si2drBooleanT si2drComplexValGetBooleanValue
SI2_ARGS((si2drAttrComplexValIdT attr, si2drErrorT *err));
...
SI2_ARGS((si2drExprT * expr, /* recursively free the structures */
          si2drErrorT *err));

si2drExprT *si2drCreateExpr
SI2_ARGS((si2drExprTypeT type, /* malloc an Expr and return it */
          si2drErrorT *err));
...
si2drStringT si2drExprToString SI2_ARGS((si2drExprT * expr, si2drErrorT *err));

si2drExprTypeT si2drExprGetType SI2_ARGS((si2drExprT * expr, si2drErrorT *err));
...
SI2_ARGS((si2drExprT * expr, /* will apply to Unary & binary Ops */
          si2drErrorT *err));
...
si2drVoidT si2drDefineGetInfo SI2_ARGS((si2drDefineIdT def, si2drStringT *name,
...
si2drVoidT si2drGroupAddName SI2_ARGS((si2drGroupIdT group, si2drStringT name,
                                       si2drErrorT *err));
...
si2drGroupIdT si2drIterNextGroup SI2_ARGS((si2drGroupsIdT iter,
                                           si2drErrorT *err));
si2drStringT si2drIterNextName SI2_ARGS((si2drNamesIdT iter, si2drErrorT *err));
si2drAttrIdT si2drIterNextAttr SI2_ARGS((si2drAttrsIdT iter, si2drErrorT *err));
si2drDefineIdT si2drIterNextDefine SI2_ARGS((si2drDefinesIdT iter,
                                             si2drErrorT *err));
si2drVoidT si2drIterQuit SI2_ARGS((si2drIterIdT iter, si2drErrorT *err));
...
si2drVoidT si2drWriteLibertyFile SI2_ARGS((char *filename, si2drGroupIdT group,
...
struct liberty_value_data {
        ...
        int *dim_sizes;           /* a malloc'd array of <dimensions> numbers,
                                                     each number is the size of the array
                                     in that dim.*/
        LONG_DOUBLE **index_info; /* a Ptr to a malloc'd array of size
                                     <dimensions>, ptrs to
                                                                 malloc'd arrays
                                     of long double index values.
                                                                 Each array of
                                     long double is of length set by
                                                                 the
                                     corresponding dim_sizes array values */
        LONG_DOUBLE *values;      /* a ptr to a malloc'd array of long doubles,
                                                              starting with
                                     [0,0,...,0,0], and ending with
                                                              [z-1,y-1,....b-1,a-1],
                                     where a-z are the max
