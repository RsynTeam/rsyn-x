...
EXTERN void defiVia_layer(const defiVia* obj, int index, char** layer, int* xl,
...
EXTERN void defiVia_viaRule(const defiVia* obj, char** viaRuleName, int* xSize,
                            int* ySize, char** botLayer, char** cutLayer,
                            char** topLayer, int* xCutSpacing, int* yCutSpacing,
                            int* xBotEnc, int* yBotEnc, int* xTopEnc,
                            int* yTopEnc);
EXTERN int defiVia_hasRowCol(const defiVia* obj);
EXTERN void defiVia_rowCol(const defiVia* obj, int* numCutRows,
                           int* numCutCols);
...
EXTERN void defiVia_offset(const defiVia* obj, int* xBotOffset, int* yBotOffset,
