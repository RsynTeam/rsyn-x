...
EXTERN int defiPinAntennaModel_hasAPinGateAreaLayer(
    const defiPinAntennaModel* obj, int index);
...
EXTERN void defiPinPort_bounds(const defiPinPort* obj, int index, int* xl,
...
EXTERN void defiPin_bounds(const defiPin* obj, int index, int* xl, int* yl,
                           int* xh, int* yh);
