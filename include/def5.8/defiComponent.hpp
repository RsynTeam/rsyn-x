...
class defiComponent {
       public:
        ...
        void setRouteHalo(int haloDist, const char* minLayer,
                          const char* maxLayer);
        // 5.7
        void clear();
        ...
        void regionBounds(int* size, int** xl, int** yl, int** xh,
                          int** yh) const;
        ...
        int foreignX() const;
        int foreignY() const;
        const char* foreignOri()
            const;                  // return the string value of the orient
