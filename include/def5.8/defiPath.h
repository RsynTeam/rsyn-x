...
EXTERN void defiPath_getViaRect(const defiPath* obj, int* deltaX1, int* deltaY1,
                                int* deltaX2, int* deltaY2);
EXTERN const char* defiPath_getViaRotationStr(const defiPath* obj);
EXTERN void defiPath_getViaData(const defiPath* obj, int* numX, int* numY,
                                int* stepX, int* stepY);
EXTERN int defiPath_getWidth(const defiPath* obj);
EXTERN void defiPath_getPoint(const defiPath* obj, int* x, int* y);
EXTERN void defiPath_getFlushPoint(const defiPath* obj, int* x, int* y,
                                   int* ext);
