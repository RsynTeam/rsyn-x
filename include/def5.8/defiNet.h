...
EXTERN void defiNet_spacingRule(const defiNet* obj, int index, char** layer,
                                double* dist, double* left, double* right);
EXTERN int defiNet_numWidthRules(const defiNet* obj);
EXTERN void defiNet_widthRule(const defiNet* obj, int index, char** layer,
                              double* dist);
