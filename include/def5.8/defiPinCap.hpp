...
class defiPin {
       public:
        ...
        void addPortVia(const char* via, int viaX, int viaY,
                        int color = 0);                            // 5.7
        ...
        void changePinName(
            const char* pinName);  // For OA to modify the pinName
        ...
        int hasAPinPartialMetalSideArea()
            const;  // ANTENNAPINPARTIALMETALSIDEAREA
