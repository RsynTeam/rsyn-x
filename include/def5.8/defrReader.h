...
typedef int (*defrStringCbkFnType)(defrCallbackType_e, const char *string,
                                   defiUserData);

/* A declaration of the signature of all callbacks that return a integer.     */
typedef int (*defrIntegerCbkFnType)(defrCallbackType_e, int number,
                                    defiUserData);

/* A declaration of the signature of all callbacks that return a double.      */
typedef int (*defrDoubleCbkFnType)(defrCallbackType_e, double number,
                                   defiUserData);

/* A declaration of the signature of all callbacks that return a defiProp.    */
typedef int (*defrPropCbkFnType)(defrCallbackType_e, defiProp *prop,
                                 defiUserData);

/* A declaration of the signature of all callbacks that return a defiSite.    */
typedef int (*defrSiteCbkFnType)(defrCallbackType_e, defiSite *site,
                                 defiUserData);

/* A declaration of the signature of all callbacks that return a defComponent */
typedef int (*defrComponentCbkFnType)(defrCallbackType_e, defiComponent *comp,
                                      defiUserData);

/* A declaration of the signature of all callbacks that return a defComponent */
typedef int (*defrComponentMaskShiftLayerCbkFnType)(
    defrCallbackType_e, defiComponentMaskShiftLayer *comp, defiUserData);
...
typedef int (*defrPathCbkFnType)(defrCallbackType_e, defiPath *path,
                                 defiUserData);
...
typedef int (*defrPinCapCbkFnType)(defrCallbackType_e, defiPinCap *pincap,
                                   defiUserData);
...
typedef int (*defrTrackCbkFnType)(defrCallbackType_e, defiTrack *track,
                                  defiUserData);

/* A declaration of the signature of all callbacks that return a defiGcellGri */
typedef int (*defrGcellGridCbkFnType)(defrCallbackType_e, defiGcellGrid *grid,
                                      defiUserData);
...
typedef int (*defrRegionCbkFnType)(defrCallbackType_e, defiRegion *,
                                   defiUserData);

/* A declaration of the signature of all callbacks that return a defiGroup.   */
typedef int (*defrGroupCbkFnType)(defrCallbackType_e, defiGroup *,
                                  defiUserData);

/* A declaration of the signature of all callbacks that return a defiAssertio */
typedef int (*defrAssertionCbkFnType)(defrCallbackType_e, defiAssertion *,
                                      defiUserData);

/* A declaration of the signature of all callbacks that return a defiScanChai */
typedef int (*defrScanchainCbkFnType)(defrCallbackType_e, defiScanchain *,
                                      defiUserData);

/* A declaration of the signature of all callbacks that return a defiIOTiming */
typedef int (*defrIOTimingCbkFnType)(defrCallbackType_e, defiIOTiming *,
                                     defiUserData);
...
typedef int (*defrTimingDisableCbkFnType)(defrCallbackType_e,
                                          defiTimingDisable *, defiUserData);

/* A declaration of the signature of all callbacks that return a defiPartitio */
typedef int (*defrPartitionCbkFnType)(defrCallbackType_e, defiPartition *,
                                      defiUserData);

/* A declaration of the signature of all callbacks that return a defiPinProp. */
typedef int (*defrPinPropCbkFnType)(defrCallbackType_e, defiPinProp *,
                                    defiUserData);

/* A declaration of the signature of all callbacks that return a defiBlockage */
typedef int (*defrBlockageCbkFnType)(defrCallbackType_e, defiBlockage *,
                                     defiUserData);
...
typedef int (*defrNonDefaultCbkFnType)(defrCallbackType_e, defiNonDefault *,
                                       defiUserData);

/* A declaration of the signature of all callbacks that return a defiStyles.  */
typedef int (*defrStylesCbkFnType)(defrCallbackType_e, defiStyles *,
                                   defiUserData);
...
EXTERN int defrRead(FILE *file, const char *fileName, defiUserData userData,
                    int case_sensitive);
