...
EXTERN void defiScanchain_start(const defiScanchain* obj, char** inst,
                                char** pin);
EXTERN void defiScanchain_stop(const defiScanchain* obj, char** inst,
                               char** pin);
...
EXTERN void defiScanchain_ordered(const defiScanchain* obj, int index,
                                  int* size, char*** inst, char*** inPin,
                                  char*** outPin, int** bits);
...
EXTERN void defiScanchain_floating(const defiScanchain* obj, int* size,
                                   char*** inst, char*** inPin, char*** outPin,
                                   int** bits);
