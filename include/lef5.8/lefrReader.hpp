...
typedef int (*lefrStringCbkFnType)(lefrCallbackType_e, const char* string,
                                   lefiUserData);

// A declaration of the signature of all callbacks that return a integer.
typedef int (*lefrIntegerCbkFnType)(lefrCallbackType_e, int number,
                                    lefiUserData);

// A declaration of the signature of all callbacks that return a double.
typedef int (*lefrDoubleCbkFnType)(lefrCallbackType_e, double number,
                                   lefiUserData);

// A declaration of the signature of all callbacks that return a lefiUnits.
typedef int (*lefrUnitsCbkFnType)(lefrCallbackType_e, lefiUnits* units,
                                  lefiUserData);

// A declaration of the signature of all callbacks that return a lefiLayer.
typedef int (*lefrLayerCbkFnType)(lefrCallbackType_e, lefiLayer* l,
                                  lefiUserData);
...
typedef int (*lefrViaRuleCbkFnType)(lefrCallbackType_e, lefiViaRule* l,
                                    lefiUserData);

// A declaration of the signature of all callbacks that return a lefiSpacing.
typedef int (*lefrSpacingCbkFnType)(lefrCallbackType_e, lefiSpacing* l,
                                    lefiUserData);

// A declaration of the signature of all callbacks that return a lefiIRDrop.
typedef int (*lefrIRDropCbkFnType)(lefrCallbackType_e, lefiIRDrop* l,
                                   lefiUserData);

// A declaration of the signature of all callbacks that return a lefiMinFeature.
typedef int (*lefrMinFeatureCbkFnType)(lefrCallbackType_e, lefiMinFeature* l,
                                       lefiUserData);

// A declaration of the signature of all callbacks that return a lefiNonDefault.
typedef int (*lefrNonDefaultCbkFnType)(lefrCallbackType_e, lefiNonDefault* l,
                                       lefiUserData);
...
typedef int (*lefrMacroCbkFnType)(lefrCallbackType_e, lefiMacro* l,
                                  lefiUserData);
...
// lefiObstruction.
typedef int (*lefrObstructionCbkFnType)(lefrCallbackType_e, lefiObstruction* l,
                                        lefiUserData);

// A declaration of the signature of all callbacks that return a lefiArray.
typedef int (*lefrArrayCbkFnType)(lefrCallbackType_e, lefiArray* l,
                                  lefiUserData);
...
typedef int (*lefrNoiseTableCbkFnType)(lefrCallbackType_e, lefiNoiseTable* p,
                                       lefiUserData);
...
typedef int (*lefrTimingCbkFnType)(lefrCallbackType_e, lefiTiming* p,
                                   lefiUserData);

// A declaration of the signature of all callbacks that return a
// lefiUseMinSpacing.
typedef int (*lefrUseMinSpacingCbkFnType)(lefrCallbackType_e,
                                          lefiUseMinSpacing* l, lefiUserData);
...
// A declaration of the signature of all callbacks that return a
// lefiMaxStackVia.
typedef int (*lefrMaxStackViaCbkFnType)(lefrCallbackType_e, lefiMaxStackVia* l,
                                        lefiUserData);

typedef int (*lefrMacroNumCbkFnType)(lefrCallbackType_e, lefiNum l,
                                     lefiUserData);

// 5.6
// A declaration of the signature of all callbacks that return a lefiDensity.
typedef int (*lefrDensityCbkFnType)(lefrCallbackType_e, lefiDensity* l,
                                    lefiUserData);
