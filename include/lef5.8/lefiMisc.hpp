...
class lefiGeometries {
        ...
        */
        ...
        void addRectIter(int colorMask, double xl, double yl, double xh,
                         double yh);
        ...
        void addStepPattern(double xStart, double yStart, double xStep,
                            double yStep);
...
class lefiSpacing {
       public:
        ...
        void set(const char* name1, const char* name2, double num,
                 int hasStack);
