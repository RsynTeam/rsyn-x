...
class lefiVia {
       public:
        ...
        void setForeign(const char* name, int hasPnt, double x, double y,
                        int orient);
        void setTopOfStack();

        void addLayer(const char* name);
        void addRectToLayer(int mask, double xl, double yl, double xh,
                            double yh);
        ...
        void setOffset(double xBot, double yBot, double xTop,
                       double yTop);              // 5.6
        ...
        int hasGenerated()
            const;  // 5.6, this no longer in 5.6, should be removed
