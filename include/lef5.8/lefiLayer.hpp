...
class lefiLayer {
       public:
        ...
        void setSpacingAdjacent(int numCuts,
                                double distance);  // 5.5for CUT layer
        ...
        void addNumProp(const char* name, const double d, const char* value,
                        const char type);
        ...
        void addPreferEnclosure(char* enclRule, double overhang1,
                                double overhang2);
        ...
        const char* minimumcutConnection(
            int index) const;  // FROMABOVE|FROMBELOW
        ...
        int hasSpacingTableOrtho()
            const;  // SPACINGTABLE ORTHOGONAL FOR LAYER CUT
       ...
       protected:
        ...
        int* hasSpacingUseLengthThreshold_;  // pcr 282799, due to mult. spacing
                                             // allow
        ...
        double*
            rangeInfluence_;  // pcr 282799 & 408930, due to mult spacing allow
