...
class lefiPin {
       public:
        ...
        void addForeign(const char* name, int hasPnt, double x, double y,
                        int orient);
...
class lefiTiming {
       public:
        ...
        void addTransition(const char* risefall, const char* unateness,
        ...
        void addSDF2Pins(const char* trigType, const char* fromTrig,
                         const char* toTrig, double one, double two,
                         double three);
        void addSDF1Pin(const char* trigType, double one, double two,
                        double three);
