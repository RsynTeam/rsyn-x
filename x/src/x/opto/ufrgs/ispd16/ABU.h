...
public:
	...
	void initAbu(Rsyn::PhysicalDesign phDesign, Rsyn::Module module, double targetUtilization, const double unit = 9.0);
	...
	double getAbuGridUnit() const {
		return clsAbuGridUnit;
	}
	...
	int getAbuNumCols() const {
		return clsAbuNumCols;
	}

	int getAbuNumRows() const {
		return clsAbuNumRows;
	}

	int getAbuNumBins() const {
		return clsAbuNumBins;
	}
	void coloringABU();
