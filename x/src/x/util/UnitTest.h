...
private:
	...
	template<typename T>
	static bool approximatelyEqual(const T a, const T b, const T precision = 1e-6) {
		return std::abs(a - b) <= 
...
public:
	...
	UnitTest(const std::string &description) : clsDescription(description) {}
	...
	template<typename T>
	static void assertApproximatelyEqual(const T x, const T y, const std::string &msg, const T precision = 1e-6) {
	...
	template<typename T>
	static void assertDefinitelyGreaterThan(const T x, const T y, const std::string &msg, const T precision = 1e-6) {
	...
	template<typename T>
	static void assertDefinitelyLessThan(const T x, const T y, const std::string &msg, const T precision = 1e-6) {
