...
void PhysicalService::stop() {}  // end method

// -----------------------------------------------------------------------------

void PhysicalService::onPostCellRemap(Rsyn::Cell cell,
...
void PhysicalService::onPostInstanceCreate(Rsyn::Instance instance) {
        ...
        PhysicalInstanceData &physicalCell =
            data->clsPhysicalInstances[instance.asCell()];
        physicalCell.clsInstance = instance;
        Rsyn::InstanceTag tag = clsDesign.getTag(instance);
        tag.setFixed(false);
        tag.setMacroBlock(physicalLibraryCell.clsMacroClass ==
                          Rsyn::MACRO_BLOCK);
        ...
        physicalCell.clsInstance->clsOrientation =
            PhysicalOrientation::ORIENTATION_N;
        ...
        physicalCell.clsInstance->clsBounds.updatePoints(
            dieOrigin.x, dieOrigin.y, dieOrigin.x + width,
            dieOrigin.y + height);
