...
class DefComponentDscp {
       public:
        ...
        std::string clsLocationType =
            INVALID_DEF_NAME;  // {FIXED | COVER | PLACED | UNPLACED }
        DBUxy clsPos;
...
class DefGroupDscp {
       public:
        ...
        std::vector<std::string>
            clsPatterns;  // It may be a pattern, e.g. "name/*"
...
class DefPortDscp {
       public:
        ...
        std::string clsDirection =
            INVALID_DEF_NAME;  // {INPUT | OUTPUT | INOUT | FEEDTHRU}
        std::string clsLocationType =
            INVALID_DEF_NAME;  // {FIXED | COVER | PLACED }
        std::string clsOrientation = INVALID_DEF_NAME;
        std::string clsLayerName = INVALID_DEF_NAME;
        std::string clsUse = INVALID_DEF_NAME;  // { SIGNAL | POWER | GROUND |
                                                // CLOCK | TIEOFF | ANALOG}
        DBUxy clsPos;
        DBUxy clsICCADPos;
...
class DefRoutingPointDscp {
       public:
         ...
         * current point and layer unchanged." Source: LEf/DEf Reference Manual
         * 5.8
         */
        Bounds clsRect;
...
class DefWireSegmentDscp {
       public:
        ...
        DefWireSegmentDscp() { clsNew = false; }  // end constructor
};                                                // end class
...
class DefSpecialNetDscp : public DefNetDscp {};  // end class
...
class DefViaDscp {
       public:
        ...
        // map->first = layerName; map->second = list of geometry rects or
        // polygons.
