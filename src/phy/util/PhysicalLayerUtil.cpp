...
std::string getPhysicalOrientation(
...
std::string getPhysicalPinGeometryClass(
    const Rsyn::PhysicalPinGeometryClass geometryClass) {
        switch (geometryClass) {
                case PINGEOMETRYCLASS_NONE:
                        return "NONE";
                case PINGEOMETRYCLASS_CORE:
                        return "CORE";
                case PINGEOMETRYCLASS_BUMP:
                        return "BUMP";
                default:
                        return Rsyn::getPhysicalInvalidName();
        }  // end switch
...
std::string getPhysicalRegionType(const Rsyn::RegionType type) {
        switch (type) {
                case RegionType::FENCE:
                        return "FENCE";
                case RegionType::GUIDE:
                        return "GUIDE";
                default:
                        return Rsyn::getPhysicalInvalidName();
        }  // end switch
...
Rsyn::PhysicalDesignMode getPhysicalDesignModeType(const std::string &type) {
        ...
        if (type.compare("FLOORPLANNING") == 0)
                return PhysicalDesignMode::FLOORPLANNING;
        if (type.compare("PLACEMENT") == 0)
                return PhysicalDesignMode::PLACEMENT;
...
std::string getPhysicalDesignModeType(const Rsyn::PhysicalDesignMode type) {
        switch (type) {
                case PhysicalDesignMode::ALL:
                        return "ALL";
                case PhysicalDesignMode::CTS:
                        return "CTS";
                case PhysicalDesignMode::FLOORPLANNING:
                        return "FLOORPLANNING";
                case PhysicalDesignMode::PLACEMENT:
                        return "PLACEMENT";
                case PhysicalDesignMode::ROUTING:
                        return "ROUTING";
                default:
                        return Rsyn::getPhysicalInvalidName();
        }  // end switch
...
std::string getPhysicalPinUseType(const Rsyn::PhysicalPinUse type) {
        switch (type) {
                case PhysicalPinUse::PIN_USE_SIGNAL:
                        return "SIGNAL";
                case PhysicalPinUse::PIN_USE_ANALOG:
                        return "ANALOG";
                case PhysicalPinUse::PIN_USE_POWER:
                        return "POWER";
                case PhysicalPinUse::PIN_USE_GROUND:
                        return "GROUND";
                case PhysicalPinUse::PIN_USE_CLOCK:
                        return "CLOCK";
                default:
                        return Rsyn::getPhysicalInvalidName();
        }  // end switch
...
Rsyn::PhysicalTrackDirection getPhysicalTrackDirectionDEF(
    const std::string &type) {
        if (type.compare("X") == 0)
                return Rsyn::PhysicalTrackDirection::TRACK_VERTICAL;
        if (type.compare("Y") == 0)
                return Rsyn::PhysicalTrackDirection::TRACK_HORIZONTAL;
...
std::string getPhysicalTrackDirectionDEF(
    const Rsyn::PhysicalTrackDirection type) {
        switch (type) {
                case PhysicalTrackDirection::TRACK_VERTICAL:
                        return "X";
                case PhysicalTrackDirection::TRACK_HORIZONTAL:
                        return "Y";
                default:
                        return Rsyn::getPhysicalInvalidName();
        }  // end switch
...
std::string getPhysicalGeneratedNamePrefix() { return GEN_NAME; }  // end method

// -----------------------------------------------------------------------------

std::string getPhysicalInvalidPrefix() { return INVALID_NAME; }  // end method

// -----------------------------------------------------------------------------

std::string getPhysicalInvalidName() { return INVALID_NAME; }  // end method

// -----------------------------------------------------------------------------

std::string getPhysicalNullName() { return NULL_PHY_NAME; }  // end method
