...
//! @brief Enum type associated to the Database Units of the LEF and DEF
//! resolutions.
...
enum DBUType : std::int8_t {
         ...
         * LEF/DEF rules allow only integer multiple between LEF and DEF DBU
         * resolutions.*/
        MULT_FACTOR_DBU = 2,
        /*! \brief Only used for Rsyn internal control.*/
        NUM_DBU = 3
...
enum PhysicalLayerType : std::int8_t {
        ...
        OVERLAP = 2,
        //! @brief Layer is defined as master slice type . They are typically
        //! polysilicon.
        MASTERSLICE = 3,
...
enum PhysicalSiteClass : std::int8_t {
        /*! \brief Only used for Rsyn internal control.*/
        INVALID_SITECLASS = -1,
        //! @brief The site is defined as PAD type. Sites are typically used in
        //! rows.
        PAD = 0,
        //! @brief The site is defined as Core type. Sites are typically used in
        //! rows.
        CORE = 1,
        /*! \brief Only used for Rsyn internal control.*/
        NUM_PHY_SITECLASS = 2
...
enum PhysicalMacroClass : std::int8_t {
        ...
        MACRO_RING = 1,
        //! @brief  Macro is Block class. It may have a subtype of
        //! PhysicalMacroBlockClass
        MACRO_BLOCK = 2,
...
//!	   Source:
//! http://vlsicad.ucsd.edu/GSRC/bookshelf/Slots/Fundamental/HGraph/
//! @todo ROT90
...
enum PhysicalSymmetry : std::int8_t {
        ...
        SYMMETRY_XY = 3,
        //! @brief Defines the symmetry in the abscissa (X) and 90 degrees
        //! rotation.
        SYMMETRY_XR90 = 4,
        //! @brief Defines the symmetry in the ordinate (Y) and 90 degrees
        //! rotation.
        SYMMETRY_YR90 = 5,
        //! @brief Defines the symmetry in the abscissa (X), ordinate (Y) and 90
        //! degrees rotation.
        SYMMETRY_XYR90 = 6,
        //! @brief Only used for Rsyn internal control.
        NUM_PHY_SYMMETRY = 7
...
enum PhysicalPinGeometryClass : std::int8_t {
        ...
        //! @brief A pin geometry has none class defined. It is the default
        //! geometry class type.
