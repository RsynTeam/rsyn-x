...
class PhysicalDesignData : public PhysicalObject {
       ...
       public:
        ...
        std::list<std::function<void(Rsyn::Instance cell)>>
            callbackAddCreatePhysicalCell;
        std::list<std::function<void(Rsyn::Instance cell)>>
            callbackOnPreCellRemoveEvent;
        Rsyn::Attribute<Rsyn::LibraryPin, PhysicalLibraryPinData>
            clsPhysicalLibraryPins;
        Rsyn::Attribute<Rsyn::Pin, PhysicalPinData> clsPhysicalPins;
        Rsyn::Attribute<Rsyn::Instance, PhysicalInstanceData>
            clsPhysicalInstances;
        Rsyn::Attribute<Rsyn::LibraryCell, PhysicalLibraryCellData>
            clsPhysicalLibraryCells;
        ...
        std::map<Rsyn::PhysicalLayer, std::vector<Rsyn::PhysicalTracks>>
            clsMapLayerToTracks;
        std::map<Rsyn::PhysicalLayer, Rsyn::PhysicalRoutingGrid>
            clsMapLayerToRoutingGrid;
        ...
        Rsyn::PhysicalDieData
            clsPhysicalDie;  // total area of the circuit including core bound.
        ...
        DBUxy clsHPWL;
        DBU clsDBUs[NUM_DBU];  // LEF and DEF data base units resolution and
                               // DEF/LEF multiplier factor
        ...
        std::array<std::list<PhysicalDesignObserver *>, NUM_PHYSICAL_EVENTS>
            clsPhysicalObservers;

        PhysicalDesignData()
            : clsClkNet(nullptr), clsDesign(nullptr), clsModule(nullptr) {
                clsLoadDesign = false;
