...
inline DBU PhysicalDesign::convertMicronToLibraryDatabaseUnits(
    const double value) const {
        return static_cast<DBU>(
            std::round(value * getDatabaseUnits(LIBRARY_DBU)));
}  // end method

// -----------------------------------------------------------------------------

inline DBU PhysicalDesign::convertMicronToDesignDatabaseUnits(
    const double value) const {
        return static_cast<DBU>(
            std::round(value * getDatabaseUnits(DESIGN_DBU)));
}  // end method
...
inline Rsyn::PhysicalLayer PhysicalDesign::getPhysicalLayerByName(
    const std::string &layerName) {
        std::unordered_map<std::string, std::size_t>::iterator element =
            data->clsMapPhysicalLayers.find(layerName);
        if (element == data->clsMapPhysicalLayers.end()) return nullptr;
        const int id = element->second;
        Element<PhysicalLayerData> *phLayerDataElement =
            data->clsPhysicalLayers.get(id);
        return PhysicalLayer(&phLayerDataElement->value);
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalSite PhysicalDesign::getPhysicalSiteByName(
    const std::string &siteName) {
        std::unordered_map<std::string, int>::iterator it =
            data->clsMapPhysicalSites.find(siteName);
        return it != data->clsMapPhysicalSites.end()
                   ? data->clsPhysicalSites[it->second]
                   : nullptr;
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalRegion PhysicalDesign::getPhysicalRegionByName(
    const std::string &siteName) {
        std::unordered_map<std::string, std::size_t>::iterator it =
            data->clsMapPhysicalRegions.find(siteName);
        if (it == data->clsMapPhysicalRegions.end()) return nullptr;
        return data->clsPhysicalRegions[it->second];
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalGroup PhysicalDesign::getPhysicalGroupByName(
    const std::string &siteName) {
        std::unordered_map<std::string, std::size_t>::iterator it =
            data->clsMapPhysicalGroups.find(siteName);
        if (it == data->clsMapPhysicalGroups.end()) return nullptr;
        return data->clsPhysicalGroups[it->second];
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalVia PhysicalDesign::getPhysicalViaByName(
    const std::string &viaName) {
        std::unordered_map<std::string, std::size_t>::iterator it =
            data->clsMapPhysicalVias.find(viaName);
        if (it == data->clsMapPhysicalVias.end()) return nullptr;
        return data->clsPhysicalVias[it->second];
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalViaRuleBase PhysicalDesign::getPhysicalViaRuleBaseByName(
    const std::string &viaName) {
        std::unordered_map<std::string, std::size_t>::iterator it =
            data->clsMapPhysicalViaRuleBases.find(viaName);
        if (it == data->clsMapPhysicalVias.end()) return nullptr;
...
inline Rsyn::PhysicalViaRule PhysicalDesign::getPhysicalViaRuleByName(
    const std::string &viaName) {
        Rsyn::PhysicalViaRuleBase viaRuleBase =
            getPhysicalViaRuleBaseByName(viaName);
...
inline Rsyn::PhysicalViaRuleGenerate
PhysicalDesign::getPhysicalViaRuleGenerateByName(const std::string &viaName) {
        Rsyn::PhysicalViaRuleBase viaRuleBase =
            getPhysicalViaRuleBaseByName(viaName);
        if (viaRuleBase == nullptr) {
                return nullptr;
        }  // end if
        return viaRuleBase.isViaRuleGenerate() ? viaRuleBase.asViaRuleGenerate()
                                               : nullptr;
}  // end method

// -----------------------------------------------------------------------------

inline int PhysicalDesign::getNumLayers(
    const Rsyn::PhysicalLayerType type) const {
...
PhysicalDesign::allPhysicalLayers() {
        return ListCollection<PhysicalLayerData, PhysicalLayer>(
            data->clsPhysicalLayers);
}  // end method
...
inline int PhysicalDesign::getNumPhysicalTracks(
    Rsyn::PhysicalLayer layer) const {
        if (!hasPhysicalTracks(layer)) return 0;
        const std::vector<Rsyn::PhysicalTracks> &tracks =
            allPhysicalTracks(layer);
        return tracks.size();
}  // end method

// -----------------------------------------------------------------------------

inline const std::vector<Rsyn::PhysicalTracks>
    &PhysicalDesign::allPhysicalTracks() const {
...
inline const std::vector<Rsyn::PhysicalTracks>
    &PhysicalDesign::allPhysicalTracks(Rsyn::PhysicalLayer layer) const {
...
inline bool PhysicalDesign::hasPhysicalTracks(Rsyn::PhysicalLayer layer) const {
        ...
        if (data->clsMapLayerToTracks.find(layer) ==
            data->clsMapLayerToTracks.end())
                return false;
        const std::vector<Rsyn::PhysicalTracks> &tracks =
            allPhysicalTracks(layer);
...
inline const std::vector<Rsyn::PhysicalRoutingGrid>
    &PhysicalDesign::allPhysicalRoutingGrids() const {
        return data->clsPhysicalRoutingGrids;
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalRoutingGrid PhysicalDesign::getPhysicalRoutingGrid(
    Rsyn::PhysicalLayer layer) const {
...
inline bool PhysicalDesign::hasPhysicalRoutingGrid(
    Rsyn::PhysicalLayer layer) const {
        if (layer == nullptr) return false;
        if (layer.getType() != Rsyn::PhysicalLayerType::ROUTING) return false;
        if (data->clsMapLayerToRoutingGrid.find(layer) ==
...
PhysicalDesign::allPhysicalSpacing() const {
        return ListCollection<PhysicalSpacingData, PhysicalSpacing>(
            data->clsPhysicalSpacing);
}  // end method
...
inline std::vector<PhysicalSpecialNet> &PhysicalDesign::allPhysicalSpecialNets()
    const {
...
PhysicalDesign::allPhysicalRows() {
        return ListCollection<PhysicalRowData, PhysicalRow>(
            data->clsPhysicalRows);
}  // end method
...
inline Rsyn::PhysicalLibraryPin PhysicalDesign::getPhysicalLibraryPin(
...
inline Rsyn::PhysicalLibraryPin PhysicalDesign::getPhysicalLibraryPin(
    Rsyn::Pin pin) const {
        if (pin.getInstanceType() != Rsyn::CELL) return nullptr;
        return PhysicalLibraryPin(
            &data->clsPhysicalLibraryPins[pin.getLibraryPin()]);
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalLibraryCell PhysicalDesign::getPhysicalLibraryCell(
...
inline Rsyn::PhysicalCell PhysicalDesign::getPhysicalCell(
    Rsyn::Cell cell) const {
...
inline Rsyn::PhysicalCell PhysicalDesign::getPhysicalCell(Rsyn::Pin pin) const {
        ...
        return instance.getType() == Rsyn::CELL
                   ? getPhysicalCell(instance.asCell())
                   : nullptr;
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalInstance PhysicalDesign::getPhysicalInstance(
...
inline Rsyn::PhysicalPort PhysicalDesign::getPhysicalPort(
    Rsyn::Port port) const {
...
inline Rsyn::PhysicalModule PhysicalDesign::getPhysicalModule(
    Rsyn::Module module) const {
...
inline int PhysicalDesign::getNumMovedCells() const {
        ...
        for (Rsyn::Instance instance : data->clsModule.allInstances()) {
                ...
                if (instance.isFixed() || instance.isMacroBlock()) continue;
...
inline Rsyn::PhysicalPin PhysicalDesign::getPhysicalPin(Rsyn::Pin pin) const {
        if (!data->clsEnablePhysicalPins) return nullptr;
...
inline DBUxy PhysicalDesign::getPinDisplacement(Rsyn::Pin pin) const {
        ...
        if (inst.getType() == Rsyn::CELL) {
                ...
                DBUxy displacement = data->clsPhysicalLibraryPins[libPin]
                                         .clsLayerBound.computeCenter();
                return displacement;
        }  // end if
        return DBUxy(0, 0);
}  // end method
...
inline DBUxy PhysicalDesign::getPinPosition(Rsyn::Pin pin) const {
        ...
        switch (type) {
                ...
                default:
                        ...
                        std::cout << "WARNING: Position for "
                                  << pin.getFullName()
                                  << " was not defined for the instance type\n";
        }  // end switch
...
inline DBU PhysicalDesign::getPinDisplacement(Rsyn::Pin pin,
...
inline DBU PhysicalDesign::getPinPosition(Rsyn::Pin pin,
                                          const Dimension dim) const {
...
inline PhysicalIndex PhysicalDesign::getId(
    Rsyn::PhysicalSpacing spacing) const {
        return spacing->id;
}  // end method
...
PhysicalDesign::createPhysicalAttribute(
    const DefaultPhysicalValueType &defaultValue) {
        return PhysicalAttributeInitializerWithDefaultValue<
            DefaultPhysicalValueType>(*this, defaultValue);
}  // end method

// -----------------------------------------------------------------------------

inline Rsyn::PhysicalOrientation PhysicalDesign::checkOrientation(
    Rsyn::PhysicalPort physicalPort, const DBU x, const DBU y) {
        ...
        if (x == lowerXBound) {
                if (y == upperYBound) return ORIENTATION_S;
                return ORIENTATION_E;
        }
        if (x == upperXBound) {
                if (y == lowerYBound) return ORIENTATION_N;
...
inline bool Rsyn::PhysicalDesign::getPhysicalPortByName(
    std::string name, Rsyn::PhysicalPort &phPort) {
...
inline void PhysicalDesign::placePort(Rsyn::PhysicalPort physicalPort,
        ...
        if (orient != ORIENTATION_INVALID) {
                ...
                newOrient = checkOrientation(physicalPort, finalPosition[X],
                                             finalPosition[Y]);
        }  // end if
        ...
        // Notify observers.
        if (moved) {
                physicalPort->clsInstance->clsPortPos.set(finalPosition[X],
                                                          finalPosition[Y]);
                if (!dontNotifyObservers) {
                        data->clsDesign.notifyInstancePlaced(
                            physicalPort.getInstance());
                }  // end if
        }          // end if
...
inline void PhysicalDesign::placePort(Rsyn::Port port, const DBU x, const DBU y,
                                      ...
                                      const bool disableSnapping,
                                      const bool dontNotifyObservers) {
        placePort(getPhysicalPort(port), x, y, orient, disableSnapping,
                  dontNotifyObservers);
}  // end method
...
inline void PhysicalDesign::placePort(Rsyn::PhysicalPort physicalPort,
                                      ...
                                      const bool disableSnapping,
                                      const bool dontNotifyObservers) {
        placePort(physicalPort, pos[X], pos[Y], orient, disableSnapping,
                  dontNotifyObservers);
}  // end method
...
inline void PhysicalDesign::placePort(Rsyn::Port port, const DBUxy pos,
                                      ...
                                      const bool disableSnapping,
                                      const bool dontNotifyObservers) {
        placePort(getPhysicalPort(port), pos[X], pos[Y], orient,
                  disableSnapping, dontNotifyObservers);
}  // end method
...
inline void PhysicalDesign::placeCell(Rsyn::PhysicalCell physicalCell,
                                      const DBU x, const DBU y,
                                      Rsyn::PhysicalOrientation orient,
                                      const bool dontNotifyObservers) {
...
inline void PhysicalDesign::placeCell(Rsyn::Cell cell, const DBUxy pos,
                                      Rsyn::PhysicalOrientation orient,
                                      const bool dontNotifyObservers) {
        placeCell(getPhysicalCell(cell), pos[X], pos[Y], orient,
                  dontNotifyObservers);
}  // end method
...
inline void PhysicalDesign::setCellOrientation(Rsyn::Cell cell,
                                               Rsyn::PhysicalOrientation orient,
                                               const bool dontNotifyObservers) {
...
inline void PhysicalDesign::flipCell(Rsyn::PhysicalCell physicalCell,
                                     const bool dontNotifyObservers) {
        ...
        switch (orient) {
                case ORIENTATION_N:
                        flippedOrient = ORIENTATION_FN;
                        break;
                case ORIENTATION_S:
                        flippedOrient = ORIENTATION_FS;
                        break;
                case ORIENTATION_W:
                        flippedOrient = ORIENTATION_FW;
                        break;
                case ORIENTATION_E:
                        flippedOrient = ORIENTATION_FE;
                        break;
                case ORIENTATION_FN:
                        flippedOrient = ORIENTATION_N;
                        break;
                case ORIENTATION_FS:
                        flippedOrient = ORIENTATION_S;
                        break;
                case ORIENTATION_FW:
                        flippedOrient = ORIENTATION_W;
                        break;
                case ORIENTATION_FE:
                        flippedOrient = ORIENTATION_E;
                        break;
                default:
                        flippedOrient = ORIENTATION_INVALID;
        }  // end switch

        if (flippedOrient != ORIENTATION_INVALID) {
                setCellOrientation(physicalCell, flippedOrient,
                                   dontNotifyObservers);
        }  // end if
}  // end method
...
inline void PhysicalDesign::flipCell(Rsyn::Cell cell,
                                     const bool dontNotifyObservers) {
...
inline void PhysicalDesign::notifyInstancePlaced(
    Rsyn::Instance instance, Rsyn::DesignObserver *ignoreObserver) {
...
inline void PhysicalDesign::setNetRouting(Rsyn::Net net,
                                          const PhysicalRouting &routing) {
        Rsyn::PhysicalNet physicalNet = getPhysicalNet(net);
        physicalNet->clsRouting = routing;

        for (PhysicalDesignObserver *observer :
             data->clsPhysicalObservers
...
inline const PhysicalRouting &PhysicalDesign::getNetRouting(
    Rsyn::Net net) const {
        Rsyn::PhysicalNet physicalNet = getPhysicalNet(net);
...
inline void PhysicalDesign::registerObserver(T *observer) {
        static_assert(
            std::is_base_of<PhysicalDesignObserver, T>::value,
        ...
        if (typeid(&PhysicalDesignObserver::onPhysicalDesignDestruction) !=
            typeid(&T::onPhysicalDesignDestruction)) {
                data->clsPhysicalObservers[PHYSICAL_EVENT_DESTRUCTION]
                    .push_back(observer);
        }  // end if

        if (typeid(&PhysicalDesignObserver::onPostNetRoutingChange) !=
            typeid(&T::onPostNetRoutingChange)) {
                data->clsPhysicalObservers
                    [PHYSICAL_EVENT_POST_NET_ROUTING_CHANGE]
                        .push_back(observer);
        }  // end if
...
inline void PhysicalDesign::unregisterObserver(
    PhysicalDesignObserver *observer) {
