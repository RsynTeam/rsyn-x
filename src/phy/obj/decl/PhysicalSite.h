...
class PhysicalSite : public Proxy<PhysicalSiteData> {
       ...
       protected:
        //! @brief Constructs a Rsyn::PhysicalSite object with a pointer to
        //! Rsyn::PhysicalSiteData.
        PhysicalSite(PhysicalSiteData* data) : Proxy(data) {}

       public:
        //! @brief Constructs a Rsyn::PhysicalSite object with a null pointer to
        //! Rsyn::PhysicalSiteData.
        ...
        //! @brief Returns the site size. In X is the width and in Y is the
        //! height.
        DBUxy getSize() const;
        ...
        DBU getHeight() const;
        //! @brief Returns site width if Dimension is X. Otherwise, returns the
        //! site height.
