...
class PhysicalPort : public PhysicalInstance {
       ...
       protected:
        //! @brief Constructs a Rsyn::PhysicalPort object with a pointer to
        //! Rsyn::PhysicalInstanceData.
        PhysicalPort(PhysicalInstanceData* data) : PhysicalInstance(data) {}

       public:
        //! @brief Constructs a Rsyn::PhysicalPort object with a null pointer to
        //! Rsyn::PhysicalInstanceData.
        ...
        // In the Rsyn the circuit pins (ports) and cells are the same object.
        // Therefore,
        // in the mapping to physical object they must be the same object.
        //! @brief Returns the object of the layer associated to the
        //! PhysicalPort
        PhysicalLayer getLayer() const;
        //! @brief Returns true if the PhysicalPort has an associated layer.
