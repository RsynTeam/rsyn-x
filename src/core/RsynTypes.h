...
enum InstanceType {
        UNKNOWN_INSTANCE_TYPE =
            0,  // used in bit fields (needs to start at zero)
...
enum BufferType { NON_INVERTING, INVERTING, ANY_BUFFER_TYPE };  // end enum

enum TieType { TIE_LOW, TIE_HIGH, ANY_TIE_TYPE };  // end enum
