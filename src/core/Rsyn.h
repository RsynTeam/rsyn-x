...
#include "core/infra/List.h"
#include "core/infra/RangeBasedLoop.h"
#include "core/infra/Exception.h"
...
using ListCollection =
    GenericListCollection<Object, Reference, RSYN_LIST_CHUNCK_SIZE>;

template <class Reference>
using ReferenceListCollection =
    GenericReferenceListCollection<Reference, RSYN_LIST_CHUNCK_SIZE>;
...
typedef CollectionOfGenericPins<Pin> CollectionOfPins;
typedef CollectionOfGenericArcs<Arc> CollectionOfArcs;
...
class TagNotSpecifiedException : public std::runtime_error {
       public:
        TagNotSpecifiedException(const std::string &tagName)
            : std::runtime_error("Trying to use the value of the tag '" +
                                 tagName + "', which was not set.") {}
};  // end class
...
// Some constants...
enum { TOPOLOGICAL_SORTING_SMALL_GAP = 10,
       TOPOLOGICAL_SORTING_LARGE_GAP = 1000 };  // end enum
...
#include "core/dscp/LibraryCell.h"
#include "core/dscp/LibraryModule.h"
...
class Global {
       public:
        static const std::string &getDirectionName(const Direction direction) {
                static const std::array<std::string, NUM_SIGNAL_DIRECTIONS>
                    NAMES = {"UNKNOWN", "INPUT", "OUTPUT", "BIDIRECTIONAL"};
                return NAMES[direction];
        }  // end method

        static const std::string &getDirectionShortName(
            const Direction direction) {
                static const std::array<std::string, NUM_SIGNAL_DIRECTIONS>
                    NAMES = {"UNKNOWN", "IN", "OUT", "BIDI"};
                return NAMES[direction];
        }  // end method

        static const std::string &getDirectionSingleCharName(
            const Direction direction) {
                static const std::array<std::string, NUM_SIGNAL_DIRECTIONS>
                    NAMES = {"?", "I", "O", "B"};
                return NAMES[direction];
        ...
        static const Direction getReverseDirection(const Direction direction) {
                static const Direction
                    DIRECTION_REVERSED[NUM_SIGNAL_DIRECTIONS] = {
...
#include "core/obj/decl/Object.h"
#include "core/obj/decl/Net.h"
#include "core/obj/decl/Pin.h"
#include "core/obj/decl/Arc.h"
#include "core/obj/decl/Instance.h"
#include "core/obj/decl/Cell.h"
#include "core/obj/decl/Port.h"
#include "core/obj/decl/Module.h"
#include "core/obj/decl/LibraryPin.h"
#include "core/obj/decl/LibraryArc.h"
#include "core/obj/decl/LibraryCell.h"
#include "core/obj/decl/LibraryModule.h"
#include "core/obj/decl/Design.h"
#include "core/obj/decl/Library.h"

// Object's Data
#include "core/obj/data/Object.h"
#include "core/obj/data/Net.h"
#include "core/obj/data/Pin.h"
#include "core/obj/data/Arc.h"
#include "core/obj/data/Instance.h"
#include "core/obj/data/Cell.h"
#include "core/obj/data/Port.h"
#include "core/obj/data/Module.h"
#include "core/obj/data/LibraryPin.h"
#include "core/obj/data/LibraryArc.h"
#include "core/obj/data/LibraryCell.h"
#include "core/obj/data/LibraryModule.h"
#include "core/obj/data/Design.h"
#include "core/obj/data/Library.h"
...
// Infra
#include "core/infra/Attribute.h"
#include "core/infra/Observer.h"

// Object's Implementations
#include "core/obj/impl/Object.h"
#include "core/obj/impl/Net.h"
#include "core/obj/impl/Pin.h"
#include "core/obj/impl/Arc.h"
#include "core/obj/impl/Instance.h"
#include "core/obj/impl/Cell.h"
#include "core/obj/impl/Port.h"
#include "core/obj/impl/Module.h"
#include "core/obj/impl/LibraryPin.h"
#include "core/obj/impl/LibraryArc.h"
#include "core/obj/impl/LibraryCell.h"
#include "core/obj/impl/LibraryModule.h"
#include "core/obj/impl/Design.h"
#include "core/obj/impl/Library.h"
