...
class LibraryCell : public Proxy<LibraryCellData> {
       ...
       public:
        ...
        //!        Returns null if the library pins do not belong to this
        //!        instance
        //!        or if no such arc is found.
        LibraryArc getLibraryArc(const Rsyn::LibraryPin from,
        ...
        //! @brief Returns the library arc from the "from" pin to the "to" pin.
        //!        Returns null if either pin is not found or if no such arc
        //!        exist
        //!        between the pins.
        LibraryArc getLibraryArcByPinNames(const std::string &from,
        ...
        //! of
        //!        a given direction.
        Range<CollectionOfLibraryPinsFilteredByDirection> allLibraryPins(
            const Direction direction) const;

        //! @brief Returns an iterable collection of all interface library pins.
        Range<CollectionOfLibraryPins> allLibraryPins() const;

        //! @brief Returns an iterable collection of all arcs.
        Range<CollectionOfLibraryArcs> allLibraryArcs() const;

        //! @brief Returns true if this library cell represents a sequential
        //! cell
        //!        and false otherwise.
        ...
        //! @brief Returns true if this library cell represents a combinational
        //! cell
        //!        and false otherwise.
        //! @note  This is a user-defined flag. If the flag was not set, an
        //! exception
        ...
        //! @brief Returns true if this library cell represents a tie cell and
        //! false
        //!        otherwise.
        //! @note  This is a user-defined flag. If the flag was not set, an
        //! exception
        ...
        //! @brief Returns true if this library cell represents a buffer cell of
        //! a
