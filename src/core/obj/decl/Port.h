...
class Port : public Instance {
       ...
       public:
        ...
        //! @brief Returns the pin inside the current level of hierarchy
        //! (module).
        //! @note  This pin belongs to the port instance.
        Pin getInnerPin() const;

        //! @brief Returns the pin in the parent hierarchy (module).
        //! @note  This pin does not belongs to the port instance. It belongs to
        //! the
        //!        parent module instance. That is the outer pin is only
        //!        virtually
        ...
        //! @note  The direction of a port matches the direction of its inner
        //! pin.
