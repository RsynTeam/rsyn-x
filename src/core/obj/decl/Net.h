...
class Net : public Proxy<NetData> {
       ...
       public:
        ...
        //! @brief Returns the number of sinks (input) pins connected to this
        //! net.
        ...
        //! @brief Returns any driver pin if any. Useful when there's an
        //! assumption
        //!        that nets have a single driver (most common case).
        Pin getAnyDriver() const;

        //! @brief Returns the arc connecting the "from" pin to the "to" pin if
        //! any.
        ...
        //! @note  The topological index of a net is the maximum topological
        //! index
        //!        of its drivers. If no drivers, it's the maximum topological
        //!        index
        //!        of its sinks. If this is a floating net (no pins), returns
        //!        the
        //!        constant value Rsyn::MIN_TOPOLOGICAL_INDEX.
        TopologicalIndex getTopologicalIndex() const;

        //! @brief Returns true if this net has more than one driver pin and
        //! false
        //!        otherwise.
        bool hasMultipleDrivers() const;

        //! @brief Returns true if this net has only and only one driver and
        //! false
        //!        otherwise.
        ...
        //! @brief Returns an iterable collection of the pins of a given
        //! direction
        //!        connected to this net.
        Range<CollectionOfPinsFilteredByDirection> allPins(
            const Direction direction) const;

        //! @brief Returns an iterable collection of the arcs spanned by this
        //! net.
        Range<CollectionOfArcs> allArcs() const;

        //! @brief Returns true if this net should be considered as ideal and
        //! false
        //!        otherwise.
        ...
        //! @note  A clock network net does not need to be directly connected to
        //! the
        //!        clock port. Internal nets of a clock buffer tree should also
        //!        be
