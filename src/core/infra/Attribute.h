...
class AttributeInitializerWithDefaultValue {
       ...
       private:
        ...
        AttributeInitializerWithDefaultValue(Design design,
                                             DefaultValueType defaultValue)
...
class Attribute
    : public std::shared_ptr<
          AttributeImplementation<RsynObject, RsynObjectExtension>> {
       public:
        Attribute() {}
        ...
        template <typename DefaultValueType>
        Attribute(AttributeInitializerWithDefaultValue<DefaultValueType>
                      initializer) {
                operator=(initializer);
        }
        template <typename DefaultValueType>
        void operator=(
            AttributeInitializerWithDefaultValue<DefaultValueType> initializer);
...
class AttributeBase {
       private:
        ...
        typename List<_Object>::DestructorCallbackHandler
       ...
       protected:
        ...
        void load(Design design, List<_Object> &list,
       ...
       public:
        AttributeBase()
            : clsDesign(nullptr), clsListPtr(nullptr) {}  // end constructor

        AttributeBase(const AttributeBase<_Object, _ObjectReference,
        ...
        AttributeBase<_Object, _ObjectReference, _ObjectExtension> &operator=(
            const AttributeBase<_Object, _ObjectReference, _ObjectExtension>
                &other) {
                unload();
        ...
        ~AttributeBase() { unload(); }  // end constructor
        ...
        inline _ObjectExtension &operator[](_ObjectReference obj) {
                return clsData[clsDesign.getId(obj)];
        }
...
template <typename _Object, typename _ObjectExtension>
class AttributeImplementation {};  // end class
...
class AttributeImplementation<Rsyn::Net, _ObjectExtension>
    : public Rsyn::AttributeBase<NetData, Net, _ObjectExtension> {
       public:
        ...
        AttributeImplementation(AttributeInitializer initializer) {
                operator=(initializer);
        }
        void operator=(AttributeInitializer initializer) {
                Design design = initializer.getDesign();
                AttributeBase<NetData, Net, _ObjectExtension>::load(
                    design, design.data->nets);
        }  // end operator
        ...
        template <typename DefaultValueType>
        void operator=(AttributeInitializerWithDefaultValue<DefaultValueType>
                           initializer) {
                Design design = initializer.getDesign();
                AttributeBase<NetData, Net, _ObjectExtension>::load(
                    design, design.data->nets, initializer.getDefaultValue());
        }  // end operator
};         // end class
...
class AttributeImplementation<Rsyn::Instance, _ObjectExtension>
    : public Rsyn::AttributeBase<InstanceData, Instance, _ObjectExtension> {
       public:
        ...
        void operator=(AttributeInitializer initializer) {
                Design design = initializer.getDesign();
                AttributeBase<InstanceData, Instance, _ObjectExtension>::load(
                    design, design.data->instances);
        }  // end operator
...
class AttributeImplementation<Rsyn::Pin, _ObjectExtension>
    : public Rsyn::AttributeBase<PinData, Pin, _ObjectExtension> {
       public:
        ...
        void operator=(AttributeInitializer initializer) {
                Design design = initializer.getDesign();
                AttributeBase<PinData, Pin, _ObjectExtension>::load(
                    design, design.data->pins);
        }  // end operator
        ...
        void operator=(AttributeInitializerWithDefaultValue<DefaultValueType>
                ...
                Design design = initializer.getDesign();
                AttributeBase<PinData, Pin, _ObjectExtension>::load(
                    design, design.data->pins, initializer.getDefaultValue());
        }  // end operator
};         // end class
...
class AttributeImplementation<Rsyn::Arc, _ObjectExtension>
    : public Rsyn::AttributeBase<ArcData, Arc, _ObjectExtension> {
       public:
        ...
        void operator=(AttributeInitializer initializer) {
                Design design = initializer.getDesign();
                AttributeBase<ArcData, Arc, _ObjectExtension>::load(
                    design, design.data->arcs);
        }  // end operator
        ...
        void operator=(AttributeInitializerWithDefaultValue<DefaultValueType>
                ...
                Design design = initializer.getDesign();
                AttributeBase<ArcData, Arc, _ObjectExtension>::load(
                    design, design.data->arcs, initializer.getDefaultValue());
        }  // end operator
};         // end class
...
class AttributeImplementation<Rsyn::LibraryCell, _ObjectExtension>
    : public Rsyn::AttributeBase<LibraryCellData, LibraryCell,
                                 _ObjectExtension> {
       public:
        AttributeImplementation() {}
        ...
        void operator=(AttributeInitializer initializer) {
                Design design = initializer.getDesign();
                AttributeBase<LibraryCellData, LibraryCell,
                              _ObjectExtension>::load(design,
                                                      design.data
                                                          ->libraryCells);
        }  // end operator
...
class AttributeImplementation<Rsyn::LibraryPin, _ObjectExtension>
    : public Rsyn::AttributeBase<LibraryPinData, LibraryPin, _ObjectExtension> {
       public:
        ...
        void operator=(AttributeInitializer initializer) {
                Design design = initializer.getDesign();
                AttributeBase<LibraryPinData, LibraryPin,
                              _ObjectExtension>::load(design,
                                                      design.data->libraryPins);
        }  // end operator
...
class AttributeImplementation<Rsyn::LibraryArc, _ObjectExtension>
    : public Rsyn::AttributeBase<LibraryArcData, LibraryArc, _ObjectExtension> {
       public:
        ...
        void operator=(AttributeInitializer initializer) {
                Design design = initializer.getDesign();
                AttributeBase<LibraryArcData, LibraryArc,
                              _ObjectExtension>::load(design,
                                                      design.data->libraryArcs);
        }  // end operator
...
template <typename RsynObject, typename RsynObjectExtension>
inline void Attribute<RsynObject, RsynObjectExtension>::operator=(
    AttributeInitializer initializer) {
        this->reset(
            new AttributeImplementation<RsynObject, RsynObjectExtension>(
                initializer));
}  // end method
...
template <typename RsynObject, typename RsynObjectExtension>
inline RsynObjectExtension
    &Attribute<RsynObject, RsynObjectExtension>::operator[](RsynObject obj) {
        return (*this)->operator[](obj);
}  // end method

template <typename RsynObject, typename RsynObjectExtension>
inline const RsynObjectExtension &Attribute<RsynObject, RsynObjectExtension>::
operator[](RsynObject obj) const {
        return (*this)->operator[](obj);
}  // end method
