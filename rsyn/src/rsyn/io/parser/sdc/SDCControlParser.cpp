...
void SDCControlParser::parseSDC_iccad14(const string & sdcFile, ISPD13::SDCInfo &sdcInfos){
...
void SDCControlParser::parseSDC_iccad15(const string & sdcFile, ISPD13::SDCInfo &sdcInfos){
	//const double TIME_UNIT = 1e-12; // [HARDCODED]
	//const double CAP_UNIT = 1e-15; // [HARDCODED]
 ...
 *
 */
void SDCControlParser::parseTiming(const string& timingFile, ISPD13::TimingInfo &timingInfo){
	...
	do {
		valid = tp.read_timing_tau15(name1, name2, val1, val2, val3, val4);
