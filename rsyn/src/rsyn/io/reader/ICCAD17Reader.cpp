...
void ICCAD17Reader::parseConstraints(const std::string & filename) {
	...
	if (!dot_parm.good()) {
		cerr << "Constraints file cannot be open `" << filename << "' for reading." << endl;
