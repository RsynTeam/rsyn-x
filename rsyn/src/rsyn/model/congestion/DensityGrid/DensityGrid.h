...
#include "rsyn/model/congestion/DensityGrid/DensityGridBin.h"
#include "rsyn/model/congestion/DensityGrid/DensityGridBlockage.h"
...
protected:
	...
	// Beta is the number of row heights which is set to compute bin dimensions.
	DBU clsBeta = 9; 
	...
	// If true, the bin dimension is computed as introduced in https://doi.org/10.1145/2160916.2160958
	// Otherwise, the bin dimension is computed considering cell width and hight
...
public:
	...
	const std::vector<Rsyn::DensityGridBlockage> & allDensityGridBlockages(const int row, const int col) const;
